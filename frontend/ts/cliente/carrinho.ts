document.addEventListener('DOMContentLoaded', () => {
    ...
    const metodoPagamentoSelect = document.getElementById('metodo-pagamento') as HTMLSelectElement;
    ...
    checkoutForm.addEventListener('submit', async (event) => {
        ...
        const trocoInput = document.getElementById('troco') as HTMLInputElement;
