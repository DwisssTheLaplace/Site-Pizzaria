...
async function atualizarStatusDoPedido(pedidoId, novoStatus) {
    const token = localStorage.getItem('authToken');
    try {
...
function adicionarBotaoVoltar(token) {
    try {
        ...
        if (cargo === 'funcionario')
            urlVoltar = 'menuFuncionario.html';
        if (cargo === 'gerente')
            urlVoltar = '../gerente/menuGerente.html';
